...
export const guest = (() => {
    ...
    const buildGoogleCalendar = () => {
        ...
        action: 'TEMPLATE',
        text: '💍 Akhil & Gopika Wedding',
        dates: `${formatDate('2026-12-28 10:00')}/${formatDate('2026-12-28 12:00')}`,
        details: `
...
📍 Venue:
Thevarumukalil Auditorium
15, Kilimanoor Madavoor Rd,
Madavoor, Kerala 695602

🗺 Maps:
https://maps.app.goo.gl/firJdKsEkEQBxjK96
            `,
        location: 'Thevarumukalil Auditorium, 15, Kilimanoor Madavoor Rd, Madavoor, Kerala 695602',
        ctz: config.get('tz'),
    });
